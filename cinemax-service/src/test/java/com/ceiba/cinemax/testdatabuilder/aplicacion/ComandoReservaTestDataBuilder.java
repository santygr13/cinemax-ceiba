...
public class ComandoReservaTestDataBuilder {
    ...
    private static final LocalDate FECHA_RESERVA_PELICULA = LocalDate.of(2020,02,27);
    ...
    private static final Factura FACTURA= new Factura(LocalDate.of(2020,02,05),21000);
